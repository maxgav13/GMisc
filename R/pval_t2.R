...
#' @description Calculates the p-value for the proposed difference of the mean between 2 samples (student-t distribution).
...
#'
pval_t2 = function(mu1, s1, n1, mu2, s2, n2, dmu = 0, side = c("two", "one")) {
  dft = n1 + n2 - 2
  t = ((mu1 - mu2) - dmu) / sqrt(s1^2/n1 + s2^2/n2)
