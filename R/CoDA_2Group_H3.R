...
#' @param comp1 A matrix of observations for composition 2.
#' @export
...
CoDA_2Group_H3 = function(comp1, comp2) {
  ...
  nu3 = D
  qchisq(.95, nu3) # critical chisq value
  pval3 = pchisq(Q3vsg, nu3, lower.tail = F) # p-value of the statistic

  res = tibble(Q = Q3vsg, nu = nu3, pval = pval3, H0 = H0)
