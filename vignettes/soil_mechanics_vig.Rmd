...
The functions for direct shear are more for visualizing the results rather than to process the. The user should analyze the raw data and provide the normal stress (`sign`) - shear stress pairs (`tau`).
...
A shinyapp using some these functions can be accessed at https://maximiliano-01.shinyapps.io/soil_mechanics/.
